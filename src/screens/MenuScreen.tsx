...
const s = StyleSheet.create({
  ...
  heroCopy: { width: '49%', padding: 18, zIndex: 2 },
  ...
  heroArt: { position: 'absolute', right: -34, top: 0, bottom: 0, width: '68%', height: '100%', borderLeftWidth: 1, borderLeftColor: 'rgba(255,255,255,0.25)' },
